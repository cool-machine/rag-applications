...
ICON_DIR = './app_assets/'
reader_model_name = "allminilm-finetuned-256"
...
## RETRIEVER
retriever = WeaviateWCS(endpoint=url, api_key=api_key, model_name_or_path=embedding_model_path) #LLM(reader_model_name)
...
available_collections = retriever.show_all_collections() #['Huberman_minilm_128', 'Huberman_minilm_256', 'Huberman_minilm_512']
